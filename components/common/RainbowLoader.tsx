...
export const SpringLoader = ({
  ...
  function startSpring() {
    ...
    secondDotPosition.value = withRepeat(
      withSpring(paddings, springParams),
      0,
      true
    );
    currentStrokeWidth.value = withTiming(strokeWidth, {
  ...
  function startWave() {
    secondDotPosition.value = height - paddings;
    secondDotPosition.value = withRepeat(
      withTiming(paddings, waveParams),
      0,
      true
    );
    currentStrokeWidth.value = withTiming(strokeWidth, {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#070707" }}>
      ...
      <View style={{ flex: 2, alignSelf: "center" }}>
        <SpringLoader
          animationType={AnimationTypes.Spring}
          width={300}
          height={150}
          strokeWidth={30}
